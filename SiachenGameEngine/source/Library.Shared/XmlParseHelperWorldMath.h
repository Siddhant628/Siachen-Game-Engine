...
namespace SiachenGameEngine
{
	...
	{
		/**
		* A XML parsing helper which can parse math structs that come inside the world.
		*/
		class XmlParseHelperWorldMath final : public IXmlParseHelper
		{
		public:
			/**
			* Default constructor initializes values.
			*/
			XmlParseHelperWorldMath();
			/**
			* Destructor.
			*/
			~XmlParseHelperWorldMath() = default;
			/**
		...
		private:
			/**
			* A pointer to the shared data object used for parsing.
			*/
